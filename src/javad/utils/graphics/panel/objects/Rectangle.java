...
public class Rectangle extends PaintableObject{

	private int w, h;
	private Point location;
	private int layer = 0;
	
	public Rectangle(int w, int h, Point location, int layer) {
	...
	public Rectangle(int w, int h, Point location) {
		this(w, h, location, 0);
	}
	...
	public void paintObject(Graphics2D g, Setting setting) {
		...
		g.drawRect(location.x, location.y, w, h);
	}
