...
public class FilledTriangle extends PaintableObject{

	private Point point1, point2, point3;
	private Point position;
	private int layer = 0;

	public FilledTriangle(Point point1, Point point2, Point point3, Point position, int layer) {
		this.point1 = point1;
		this.point2 = point2;
		this.point3 = point3;
	...
	public FilledTriangle(Point point1, Point point2, Point point3, Point position) {
		this.point1 = point1;
		this.point2 = point2;
		this.point3 = point3;
		this.position = position;
	...
	public FilledTriangle(int w1, int w2, int w3, Point position) {
	...
	public void paintObject(Graphics2D g, Setting setting) {
		...
		g.fillPolygon(new int[] {position.x + point1.x, position.x + point2.x, position.x + point3.x}, new int[] {position.y + point1.y, position.y + point2.y, position.y + point3.y}, 3);
	}
