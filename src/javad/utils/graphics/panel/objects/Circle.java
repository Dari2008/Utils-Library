...
public class Circle extends PaintableObject{

	private int radius = 0;
	private int layer = 0;
	private Point location;

	public Circle(int diameter, Point location, int layer) {
		radius = diameter/2;
		this.layer = layer;
		this.location = location;
	}

	public Circle(Point location, int radius, int layer) {
	...
	public Circle(float radius, Point location) {
		this.radius = (int) radius;
		this.layer = 0;
		this.location = location;
	}
	...
	public void paintObject(Graphics2D g, Setting setting) {
		...
		g.drawOval(location.x, location.y, radius*2, radius*2);
	}
